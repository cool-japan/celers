...
See [ROADMAP.md](/tmp/ROADMAP.md) for detailed development plan.
...
- **Q1 2025**: Celery Protocol v2 compatibility
- **Q2 2025**: Advanced broker support (RabbitMQ, SQS)
- **Q3 2025**: Production-grade Canvas workflows
- **Q4 2025**: v1.0.0 release

## 📖 Documentation

- [Architecture Decision Records](docs/adr/) - Key design decisions
- [Performance Guide](/tmp/PERFORMANCE.md) - Optimization strategies
- [Grafana Dashboards](/tmp/GRAFANA.md) - Monitoring setup
- [OpenTelemetry Integration](/tmp/OPENTELEMETRY.md) - Distributed tracing
