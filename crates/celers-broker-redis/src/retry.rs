...
impl ErrorKind {
    ...
    pub fn from_redis_error(err: &redis::RedisError) -> Self {
        ...
        match err.kind() {
            RedisErrorKind::IoError => ErrorKind::Connection,
            RedisErrorKind::BusyLoadingError => ErrorKind::Connection,
            RedisErrorKind::TryAgain => ErrorKind::Connection,
            RedisErrorKind::ClusterDown => ErrorKind::Connection,
            RedisErrorKind::MasterDown => ErrorKind::Connection,
            RedisErrorKind::AuthenticationFailed => ErrorKind::Authentication,
            RedisErrorKind::ResponseError => ErrorKind::Command,
            RedisErrorKind::TypeError => ErrorKind::Command,
            _ => ErrorKind::Unknown,
        }
    }
